                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                @foreach ($schedules as $schedule)
                                                    <tr>
                                                        <td>{{ $schedule->teacherClassroomRelationship->teacherSubjectRelationship->subject->name }}</td>
                                                        <td>{{ $schedule->teacherClassroomRelationship->teacherSubjectRelationship->teacher->name }}</td>
