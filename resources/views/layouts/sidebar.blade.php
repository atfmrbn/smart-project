        ...
        <div id="sidebar-menu" class="sidebar-menu">
            <ul>
                ...
                <li class="nav-item {{ request()->is('dashboard/admin') ? 'active' : '' }}">
                    <a href="{{ route('admin.dashboard') }}" class="{{ request()->is('dashboard/admin') ? 'active' : '' }}"><i class="feather-grid"></i><span> Admin Dashboard</span></a>
                </li>
                @endif
                ...
                <li class="nav-item {{ request()->is('dashboard/parent') ? 'active' : '' }}">
                    <a href="{{ route('parent.dashboard') }}" class=""><i class="feather-grid"></i><span> Parent Dashboard</span></a>
                </li>
                @endif
                    {{-- </ul>
                </li> --}}
