                    ...
                    <tr class="text-center">
                        ...
                        <td class="align-middle text-center">
                            <div class="d-flex justify-content-center align-items-center">
                                <a title="Lihat" href="{{ URL::to('task-type/' . $taskType->id) }}"
                                    class="btn btn-sm btn-outline-info me-2"><i class="fas fa-eye"></i></a>
                                <a title="Edit" href="{{ URL::to('task-type/' . $taskType->id . '/edit') }}"
                                ...
                                <form action="{{ URL::to('task-type/' . $taskType->id) }}" method="post">
                                    ...
                                    <button type="submit" title="Hapus" class="btn btn-sm btn-outline-danger me-2"
                                        onclick="return confirm('Anda yakin mau menghapus data ini {{ $taskType->name }}?')">
