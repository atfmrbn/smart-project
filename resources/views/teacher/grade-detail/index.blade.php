        ...
        <div class="row align-items-center">
            ...
            <div class="col-auto ms-auto">
                <div class="btn-group" role="group" aria-label="Actions">
                    ...
                    <a href="{{ route('grade-detail.create') }}" class="btn btn-primary"><i class="fas fa-plus me-1"></i>Add Grade Detail</a>
                </div>
            </div>
        </div>
    </div>
                ...
                <tr>
                    ...
                    <td class="text-center">
                        <div class="btn-group" role="group" aria-label="Grade Detail Actions">
                            <a href="{{ route('grade-detail.edit', $gradeDetail->id) }}" class="btn btn-sm btn-outline-primary me-1">
                                <i class="fas fa-edit"></i>
                            </a>
                            <form method="POST" action="{{ route('grade-detail.destroy', $gradeDetail->id) }}" onsubmit="return confirm('Are you sure you want to delete this grade detail?')">
                                @csrf
                                @method('DELETE')
